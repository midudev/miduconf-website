  ...
  return (
    <article
      className={cn(
        ...
        hologram === 'standard'
          ? `bg-gradient-to-tr ${colorStyles.outer}`
          : 'bg-gradient-to-tr from-white/20 via-transparent to-white/20 border-palette-border-foreground',
    ...
    >
      ...
      {hologram === 'standard' && (
        <div className='absolute inset-0 pointer-events-none rounded-xl bg-gradient-to-tr from-white/10 via-transparent to-white/10 opacity-80' />
      )}
      {/* Physics Background */}
      ...
      <div
        className={cn(
          ...
          hologram === 'standard'
            ? `bg-gradient-to-tr ${colorStyles.inner}`
            : 'bg-gradient-to-tr from-[#1f1f25] via-[#101015] to-[#1f1f25] border border-palette-border-foreground',
      ...
      >
        ...
        />
        <header className={cn('p-6 uppercase max-sm:p-5 pb-4 max-sm:pb-2')}>
          <p
            className={cn(
                  ...
                  {StickerComponent?.StickerImage && (
                    <div className='absolute items-center justify-center hidden w-full h-full border border-dashed group-hover:flex bg-palette-ghost/20 border-white/5'>
                      <Button
                        ...
                        containerClassName='hidden group-hover:flex absolute top-1 right-1 z-20'
                        className='p-2'
                        onClick={() => handleRemoveSticker?.(sticker!)}
                        aria-label={`Elminar sticker de ${sticker}`}
                      >
