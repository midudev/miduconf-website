...
export const TicketCard = ({ fullname, ticketNumber, username, hologram = 'standard', twitchTier }: Props) => {
	...
	const getHologramStyles = (hologram: HologramOption) => {
		...
		switch (hologram) {
			case 'twitch-1':
				styles.outer = 'after:w-full after:h-full after:absolute after:left-0 after:top-0 after:bg-[url(/tickets/gradient.png)] after:opacity-20 from-pink-200/20 to-sky-200/20'
				styles.inner = 'after:w-full after:h-full after:absolute after:left-0 after:top-0 after:bg-[url(/tickets/gradient.png)] after:opacity-20 from-pink-200/20 to-sky-200/20 before:w-full before:h-full before:absolute before:left-0 before:top-0 before:bg-gradient-to-tr before:from-[#1f1f25] before:via-[#101015] before:to-[#1f1f25] before:-z-10'
				styles.logo = 'text-pallet-background [filter:drop-shadow(-2px_-2px_.5px_#695f68)_drop-shadow(2px_2px_.5px_#59646f)_drop-shadow(-2px_2px_.5px_#695f68)_drop-shadow(2px_-2px_.5px_#596460)]'
				styles.text = 'bg-gradient-to-r from-pink-200 via-white to-sky-200 bg-clip-text text-transparent'
				styles.badge = {
					label: 'Tier 1',
			...
			case 'twitch-2':
				styles.outer = 'after:w-full after:h-full after:absolute after:left-0 after:top-0 after:bg-[url(/tickets/gradient.png)] after:opacity-15 from-[#F8F4CE]/20 to-[#C6C2DD]/20'
				...
				styles.text = 'bg-gradient-to-r from-[#F8F4CE] via-[#D1B8DF] to-[#C6C2DD] bg-clip-text text-transparent'
				styles.badge = {
					label: 'Tier 2',
			...
			case 'twitch-3':
				...
				styles.logo = 'text-[#FCFCFA] [filter:drop-shadow(0_0_6px_#9CFCC4)_drop-shadow(0_0_4px_#B3A1E5)]'
				styles.text = 'bg-gradient-to-r from-[#9CFCC4] via-[#B3A1E5] via-[#F2B4E0] to-[#D5DFC5] bg-clip-text text-transparent font-bold [text-shadow:0_0_15px_rgba(156,252,196,0.6)]'
				styles.badge = {
					label: 'Tier 3',
