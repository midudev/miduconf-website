...
export const TicketCard = ({
	...
	return (
		<article
			className={cn(
				'w-[426px] h-[463px] sm:w-[326px] sm:h-[463px] md:w-[426px] md:h-[563px] max-sm:w-full max-w-[375px] overflow-hidden p-2 bg-gradient-to-tr from-white/20 via-transparent to-white/20 rounded-2xl border border-pallet-border-foreground',
		...
		>
			...
			>
				...
				<footer className='flex flex-col justify-end flex-1'>
					<span
						className={cn(
							'mb-2 mx-auto font-medium text-[calc(426px_/_7)] sm:text-[calc(375px_/_6)] md:text-[calc(375px_/_5)] tabular-nums leading-none',
							hologramStyles.text && hologramStyles.text
						)}
					>
					...
					<time
						...
						className={cn(
							'flex items-center justify-between gap-4 px-6 pb-6 text-lg sm:px-5 sm:pb-5 sm:text-base',
							hologramStyles.text && hologramStyles.text
						)}
					>
