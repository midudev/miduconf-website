...
export const ViewTicketMobile = ({
	...
	return (
		<div className='relative w-full min-h-screen lg:hidden'>
			...
			<div
				className={`flex items-center justify-center p-4 md:p-8 ${isPanelOpen ? 'h-[calc(100vh-55vh)] pt-20' : 'min-h-screen pb-20 pt-32'
					}`}
			>
				<div
					className={`transition-transform duration-300 ${isPanelOpen ? 'scale-[0.55] sm:scale-[0.6] md:scale-[0.65]' : 'scale-100'
						}`}
				>
					<TicketCard
						fullname={fullname}
