...
export function LogoutButton() {
	...
	return (
		<button
			type="button"
			title="Cerrar Sesión"
			class="absolute top-4 right-4 flex flex-col lg:items-center lg:flex-row font-semibold tracking-tight gap-x-2 text-slate-700 hover:border-b-black hover:text-black my-2"
			onClick={logout}
		>
