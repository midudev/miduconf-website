	...
	return (
		...
		>
			{highlights.map((highlight, key) => (
				...
				>
					<div>
						<span className='highlight-text uppercase font-semibold text-[100px] lg:text-[180px] block text-palette-ghost/30 hover:text-palette-primary transition-colors leading-none'>
							{highlight}
						</span>
					</div>
					<DiamondIcon className='size-spacing-32 text-palette-primary lg:size-spacing-40 star-highlight' />
				</li>
			))}
		</ul>
	)
