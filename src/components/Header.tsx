...
function Navbar() {
  ...
  return (
    <>
      <nav>
        <ul className='relative z-20 flex gap-4'>
          ...
          <button
            ref={refButton}
            onClick={toggleMenu}
            className='burguer px-[12px] py-[10px] border border-pallet-border-foreground bg-pallet-b-foreground-primary rounded-[5px] flex justify-center items-center lg:hidden cursor-pointer'
          >
        ...
        <ul
          ...
          ref={refNavbarList}
          className={cn(
            'navbarList clipHidden absolute inset-0 lg:inset-auto h-screen lg:h-auto flex flex-col lg:flex-row justify-end items-end p-5 space-y-8 bg-pallet-background lg:top-[28px] lg:bottom-auto pt-[80px] pb-5 lg:clipVisible lg:bg-transparent lg:p-0 lg:left-1/2 lg:-translate-x-1/2 lg:justify-center lg:items-center lg:space-y-0'
          )}
        >
              ...
              >
                <Link
                  ...
                  className={cn(
                    ...
                    currentHash === href
                      ? 'text-pallet-default hover:text-pallet-default'
      ...
      <div className='absolute inset-0 invisible w-full h-screen opacity-50 navbar-overlay bg-pallet-background z-9'></div>
    </>
  )
}
