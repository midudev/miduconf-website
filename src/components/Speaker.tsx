...
export const Speaker: React.FC<SpeakerProps> = ({ name, img, title, isPlaceholder = false }) => {
  ...
  if (isPlaceholder) {
    return (
      <li className='speaker w-full md:min-w-[336px] md:max-w-[636px] mx-auto'>
  ...
  return (
    <li ref={containerRef} className='speaker w-full md:min-w-[336px] md:max-w-[636px] mx-auto'>
      <div className='relative overflow-hidden w-full'>
        <canvas
          ref={canvasRef}
          className='pixel-canvas w-full object-cover aspect-[712/912] block rounded-[5px] speaker-image'
        ...
        <p className='absolute inline-flex items-center gap-2 py-[6px] px-[12px] md:py-[6px] md:px-[10px] text-body-code border rounded-[5px] bg-palette-bg-foreground-primary border-palette-border-foreground bottom-spacing-16 left-spacing-16'>
