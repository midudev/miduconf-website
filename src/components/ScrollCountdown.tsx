...
export const ScrollCountdown = ({ scrollClockRef }) => {
  ...
  return (
    <div className='counter-scroll hidden lg:block p-spacing-8 bg-pallet-b-foreground-primary border border-pallet-border-foreground rounded-[5px] text-xl-code space-y-spacing-16 fixed -translate-x-full z-10 left-0 top-spacing-96 w-full max-w-[290px]'>
      <header className='flex justify-between counter-scroll-header'>
        ...
        <button
          ref={buttonRef}
          className='counter-scroll-button bg-pallet-bg-foreground-secondary size-5 flex justify-center items-center rounded-[3px] hover:cursor-pointer'
        >
      ...
      <footer className='flex justify-between items-center counter-scroll-footer'>
        <div className='flex flex-col text-body-code items-center'>
          ...
          <span className='counter-date-scroll text-pallet-ghost'>days</span>
        </div>
        <span>:</span>
        <div className='flex flex-col items-center text-body-code'>
          <span className='counter-hours'>{mounted ? hours : '00'}</span>
          <span className='counter-date-scroll text-pallet-ghost'>hrs</span>
        </div>
        <span>:</span>
        <div className='flex flex-col items-center text-body-code'>
          <span className='counter-minutes'>{mounted ? minutes : '00'}</span>
          <span className='counter-date-scroll text-pallet-ghost'>min</span>
        </div>
        <span>:</span>
        <div className='flex flex-col items-center text-body-code'>
          <span className='counter-seconds'>{mounted ? seconds : '00'}</span>
          <span className='counter-date-scroll text-pallet-ghost'>sec</span>
        </div>
      </footer>
    </div>
  )
