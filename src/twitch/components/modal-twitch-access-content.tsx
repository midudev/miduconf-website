	...
	return (
		<div className='flex flex-col items-center justify-center gap-2 text-balance'>
			...
			<div className='px-4 py-6'>
				...
				<div className='flex items-center justify-center gap-2 px-4 py-2 mx-auto text-white uppercase bg-palette-ghost/20 w-max'>
					{Array(tierNumber)
						.fill(null)
						.map((_, index) => {
							return (
								<img
									...
									className={cn(
										'w-6 h-6  border rounded-full border-palette-border-foreground',
										index >= 1 && '-ml-4'
									)}
									width='30'
									height='30'
				...
				<p className='mt-4 text-center text-palette-ghost max-w-[40ch] text-pretty mx-auto'>
