...
export const Gifts = () => {
	return (
		<section id='regalos' className='px-4 pt-24'>
			<div className='flex relative group flex-col gap-4 py-20 mx-auto shadow-[inset_0_4px_30px] shadow-midu-primary/25 overflow-hidden rounded-2xl bg-midu-primary/10 max-w-screen-base'>
