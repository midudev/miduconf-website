	...
	return (
		<>
			<Head>
				...
				<meta property='og:image' content={`${url}${defaultOgImage}`} />
				<meta property='twitter:image' content={`${url}${defaultOgImage}`} />
				...
				<meta property='og:type' content={`${url}${defaultOgImage}`} />
